    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        ...
        <div className="space-y-4">
          <button
            onClick={handleClick}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-semibold text-gray-700"
          >
          ...
          <div className="text-center text-sm text-gray-500 mt-6">
            By signing in, you agree to sync your data securely with your account
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-center gap-2">
              ...
              Track time across all your devices
            </li>
            <li className="flex items-center gap-2">
              <span className="text-green-500">✓</span>
